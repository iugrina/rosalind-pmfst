...
def kmersNeighbours(text, k):
    """
    Find all k-mers (words) and their Neighbors in a string text
    together with a minimal hamming distance between neighbors
    and the set of original k-mers
    """
